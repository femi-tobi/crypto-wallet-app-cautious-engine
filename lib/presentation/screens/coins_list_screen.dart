              ...
              builder: (context, visible, _) {
                return Column(
                  children: [
                    ...
                    Text(visible ? '\$23,450.00' : '••••••', style: const TextStyle(fontSize: 42, fontWeight: FontWeight.bold)),
                  ],
                );
              },
            ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text('Offline Mode', style: TextStyle(color: Colors.grey)),
            const Text('Showing cached data', style: TextStyle(fontSize: 12, color: Colors.grey)),
            const SizedBox(height: 16),
            ElevatedButton.icon(onPressed: () => repo.fetchCoins(forceRefresh: true), icon: const Icon(Icons.refresh), label: const Text('Refresh')),
          ],
        ),
      );
    }
